...
<%@page import="br.com.unicarioca.projetointegrador.timec.controller.AnaliseReembolsoControle"%>
<%@page import="br.com.unicarioca.projetointegrador.timec.vo.AnaliseReembolsoVo"%>
...
<jsp:useBean id="obj" class="br.com.unicarioca.projetointegrador.timec.controller.AnaliseReembolsoControle"/>

<%



AnaliseReembolsoControle analiseReembolso = new AnaliseReembolsoControle();
AnaliseReembolsoVo vo = new AnaliseReembolsoVo();
vo = analiseReembolso.analisarSolicitacaoReembolso(1);
